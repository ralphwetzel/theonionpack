...
class VersionManager(object):
    ...
    class PackVersion(Version):
        def __init__(self, last_mod):
            super().__init__(last_mod)
            self.version = None

    class obfsVersion(Version):
        def __init__(self, last_mod):
            super().__init__(last_mod)
            self.version = None

    def __init__(self, proxy: str, current_version, system: str = 'Windows', release: str = platform.release()):
        ...
        self.Pack = self.PackVersion(self.lmc)
        self.obfs = self.obfsVersion(self.lmc)
    ...
    def update(self):
        ...
        _pack = back.get('pack', None)
        if _pack is not None:
            self.Pack.version = _pack.get('version', None)
